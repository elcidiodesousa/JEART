...
<div id="popup" class="popup">
  ...
  <div class="message">
   Compra efectuada com sucesso!
    ...
    <a href="#" onclick="closePopup();" class="close-button">Fechar</a>
      ...
      <div class="tabela1">
          <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Tigre</p>
          <a href=""><img class="tbl1" src="img/aimal1.jpg" alt=""></a>
  <input type="checkbox" name="imagem1" id="valor1" value="3000"> 
    ...
    <div class="tabela2">
       ...
       <a href=""><img src="img/animal2jpg.jpg" alt="" class="tbl1"></a> 
  <input type="checkbox" name="imagem1" id="valor2" value="2500">
    ...
    <div class="tabela3">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Matilha</p>
    <a href=""><img src="img/animal3jpg.jpg" alt="" class="tbl1"></a> 
  <input type="checkbox" name="imagem1" id="valor3" value="2900">
    ...
    <div class="tabela4">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Iris</p>
    <a href=""> <img src="img/animal4jpg.jpg" alt="" class="tbl1"></a>
  <input type="checkbox" name="imagem1" id="valor4" value="3500">
    ...
    <div class="tabela5">
         <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Rapousa</p>
         <a href=""> <img src="img/animal5jpg.jpg" alt="" class="tbl1"></a>
  <input type="checkbox" name="imagem1" id="valor5" value="1500">
    ...
    <div class="tabela6">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Cachorro</p>
    <a href=""><img class="tbl1" src="img/animal6jpg.jpg" alt=""></a>
<input type="checkbox" name="imagem1" id="valor1" value="1100">
  <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">1100 MTS</p>
    ...
    <div class="tabela7">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Cachorro Cinema</p>
    <a href=""><img src="img/animal7jpg.jpg" alt="" class="tbl8"></a> 
<input type="checkbox" name="imagem1" id="valor2" value="1700">
    ...
    <div class="tabela8">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Aguia acrco-iris</p>
    <a href=""> <img src="img/foto11.jpg" alt="" class="tbl8"></a>
<input type="checkbox" name="imagem1" id="valor4" value="1700">
  <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">1500 MTS</p>
    </div>

    <div class="tabela9">
    <p style= "color: white; font-size: 20px; font-family:'Times New Roman', Times, serif; margin-left: 1px;">Ouvir, Ver e Calar</p>
    <a href=""><img src="img/animal8jpg.jpg" alt="" class="tbl8"></a> 
